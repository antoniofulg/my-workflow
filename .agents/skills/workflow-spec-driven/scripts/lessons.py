#!/usr/bin/env python3
"""
lessons.py - deterministic bookkeeping for the workflow-spec-driven lessons layer.
...
def main(argv=None):
    p = argparse.ArgumentParser(prog="lessons.py", description="Deterministic lessons bookkeeping for workflow-spec-driven.")
