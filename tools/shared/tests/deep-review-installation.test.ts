...
describe("deep-review installation", { timeout: 30_000 }, () => {
  it("keeps the skill, lock metadata, release version, and project discovery aligned", () => {
    ...
    expect(lockEntry).toEqual({
      ...
      computedHash: "f184149bcfeb019f85e47b61c46612d77c9bca3c38209044851802f51941ebd0",
    });
    ...
    expect(packageManifest.version).toBe("0.3.6");
    expect(packageLock.version).toBe("0.3.6");
    expect(packageLock.packages?.[""]?.version).toBe("0.3.6");
