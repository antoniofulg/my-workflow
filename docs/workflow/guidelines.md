...
| [GATES.md](../guidelines/GATES.md) | The full product gate after every atomic task is the largest avoidable cost. Scoped gate per slice; full gate once. Never skip a test to go green. Cached evidence only for the exact tree. |
