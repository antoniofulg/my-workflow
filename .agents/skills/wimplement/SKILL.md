...
A deep-review Minor-only closeout batch is not a new slice; follow
`docs/guidelines/REVIEW-ROUNDS.md` for its single scoped gate and commit without a fresh proof cycle.
