...
| MAS-03 | P1: Closure fields validate | DR1 | Verified |
...
| MAS-10 | P1: Remediation does not inflate slices | R1 | Verified |
| MAS-11 | P1: Downstream planners share membership | DR1 | Verified |
