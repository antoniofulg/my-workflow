...
1. Read the repository description, credits, adoption contract, skills list, and out-of-scope text.
2. Follow the Tech Leads Club and Pedro Nauck source links and compare them with the local authorship
   statements.
3. Inspect the package and lockfile root metadata for the published workflow version.
