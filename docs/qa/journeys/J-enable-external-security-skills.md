...
2. Run the installer without authorization and confirm it only prints the pinned plan.
...
6. Exercise a safe refusal from a disposable pack copy and confirm the target is restored and the
   security gate is reported unavailable.
