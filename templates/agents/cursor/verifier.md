...
- QA Execute: return the report/status/evidence paths and defects. Hand each product defect to an
  Implementer. Close this session and require a fresh Verifier for Blocker or Major fixes; for a
  Minor, resume this QA Execute session after the active feature's scoped remediation gate.
